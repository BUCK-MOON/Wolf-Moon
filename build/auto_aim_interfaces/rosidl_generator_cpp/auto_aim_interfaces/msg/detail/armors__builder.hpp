...
class Init_Armors_get_armor
{
public:
  explicit Init_Armors_get_armor(::auto_aim_interfaces::msg::Armors & msg)
  : msg_(msg)
  {}
  Init_Armors_armors get_armor(::auto_aim_interfaces::msg::Armors::_get_armor_type arg)
  {
    msg_.get_armor = std::move(arg);
...
public:
  ...
  {}
  Init_Armors_get_armor header(::auto_aim_interfaces::msg::Armors::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_Armors_get_armor(msg_);
  }
