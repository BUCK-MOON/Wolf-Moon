...
bool auto_aim_interfaces__msg__serial__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auto_aim_interfaces.msg._serial.Serial", full_classname_dest, 38) == 0);
  }
  auto_aim_interfaces__msg__Serial * ros_message = _ros_message;
  {  // header
  ...
  {  // shoot_delay
    ...
    assert(PyFloat_Check(field));
    ros_message->shoot_delay = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * auto_aim_interfaces__msg__serial__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_aim_interfaces.msg._serial");
  ...
  {  // shoot_delay
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->shoot_delay);
    {
