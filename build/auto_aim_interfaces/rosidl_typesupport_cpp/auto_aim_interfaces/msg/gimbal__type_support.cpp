...
static const _Gimbal_type_support_symbol_names_t _Gimbal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, Gimbal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auto_aim_interfaces, msg, Gimbal)),
  }
};
...
{
  return &::auto_aim_interfaces::msg::rosidl_typesupport_cpp::Gimbal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auto_aim_interfaces, msg, Gimbal)() {
  return get_message_type_support_handle<auto_aim_interfaces::msg::Gimbal>();
}
