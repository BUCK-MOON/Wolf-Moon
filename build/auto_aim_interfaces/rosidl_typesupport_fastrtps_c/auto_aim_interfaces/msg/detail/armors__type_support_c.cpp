  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: get_armor
  {
    cdr << (ros_message->get_armor ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: get_armor
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->get_armor = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name get_armor
  {
    size_t item_size = sizeof(ros_message->get_armor);
...
{
  return max_serialized_size_auto_aim_interfaces__msg__Armors(
    full_bounded, 0);
}
