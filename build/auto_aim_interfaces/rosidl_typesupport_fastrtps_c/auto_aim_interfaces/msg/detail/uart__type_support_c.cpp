...
#include "auto_aim_interfaces/msg/detail/uart__rosidl_typesupport_fastrtps_c.h"
...
using _Uart__ros_msg_type = auto_aim_interfaces__msg__Uart;
...
size_t get_serialized_size_auto_aim_interfaces__msg__Uart(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Uart__ros_msg_type * ros_message = static_cast<const _Uart__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Uart__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__Uart(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__Uart(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_auto_aim_interfaces__msg__Uart(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Uart)() {
