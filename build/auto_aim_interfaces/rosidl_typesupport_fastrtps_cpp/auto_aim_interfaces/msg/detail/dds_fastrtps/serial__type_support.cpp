...
#include "auto_aim_interfaces/msg/detail/serial__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auto_aim_interfaces::msg::Serial & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::Serial & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::Serial *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::Serial *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Serial(full_bounded, 0);
}
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Serial__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, Serial)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Serial__handle;
}
