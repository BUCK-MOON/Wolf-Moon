  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  auto_aim_interfaces__msg__Point2f__init(message_memory);
}

void Point2f__rosidl_typesupport_introspection_c__Point2f_fini_function(void * message_memory)
{
  auto_aim_interfaces__msg__Point2f__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Point2f__rosidl_typesupport_introspection_c__Point2f_message_member_array[2] = {
  {
    ...
    offsetof(auto_aim_interfaces__msg__Point2f, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Point2f, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Point2f__rosidl_typesupport_introspection_c__Point2f_message_members = {
  ...
  2,  // number of fields
  sizeof(auto_aim_interfaces__msg__Point2f),
