...
{
  new (message_memory) auto_aim_interfaces::msg::Point2f(_init);
}

void Point2f_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auto_aim_interfaces::msg::Point2f *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point2f_message_member_array[2] = {
  {
    ...
    offsetof(auto_aim_interfaces::msg::Point2f, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::Point2f, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point2f_message_members = {
  ...
  2,  // number of fields
  sizeof(auto_aim_interfaces::msg::Point2f),
...
get_message_type_support_handle<auto_aim_interfaces::msg::Point2f>()
{
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::Point2f_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auto_aim_interfaces, msg, Point2f)() {
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::Point2f_message_type_support_handle;
}
