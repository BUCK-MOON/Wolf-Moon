...
#ifndef IG_LIO_C_MSGS__SRV__DETAIL__COVERT_MAP__FUNCTIONS_H_
#define IG_LIO_C_MSGS__SRV__DETAIL__COVERT_MAP__FUNCTIONS_H_
...
/// Initialize srv/CovertMap message.
/**
...
/// Finalize srv/CovertMap message.
/**
...
/// Create srv/CovertMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ig_lio_c_msgs__srv__CovertMap_Request__init().
...
/// Destroy srv/CovertMap message.
/**
 * It calls
 * ig_lio_c_msgs__srv__CovertMap_Request__fini()
...
/// Check for srv/CovertMap message equality.
/**
...
/// Initialize array of srv/CovertMap messages.
/**
...
/// Finalize array of srv/CovertMap messages.
/**
 * It calls
 * ig_lio_c_msgs__srv__CovertMap_Request__fini()
...
/// Create array of srv/CovertMap messages.
/**
 * It allocates the memory for the array and calls
 * ig_lio_c_msgs__srv__CovertMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CovertMap messages.
/**
 * It calls
 * ig_lio_c_msgs__srv__CovertMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CovertMap message array equality.
/**
...
/// Copy an array of srv/CovertMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ig_lio_c_msgs__srv__CovertMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ig_lio_c_msgs
...
/**
 * It calls
 * ig_lio_c_msgs__srv__CovertMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ig_lio_c_msgs
...
/**
 * It allocates the memory for the array and calls
 * ig_lio_c_msgs__srv__CovertMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ig_lio_c_msgs
...
/**
 * It calls
 * ig_lio_c_msgs__srv__CovertMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IG_LIO_C_MSGS__SRV__DETAIL__COVERT_MAP__FUNCTIONS_H_
