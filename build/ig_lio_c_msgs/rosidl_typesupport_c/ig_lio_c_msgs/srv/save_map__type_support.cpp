...
static const _SaveMap_Request_type_support_symbol_names_t _SaveMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ig_lio_c_msgs, srv, SaveMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ig_lio_c_msgs, srv, SaveMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ig_lio_c_msgs, srv, SaveMap_Request)() {
  return &::ig_lio_c_msgs::srv::rosidl_typesupport_c::SaveMap_Request_message_type_support_handle;
}
...
static const _SaveMap_Response_type_support_symbol_names_t _SaveMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ig_lio_c_msgs, srv, SaveMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ig_lio_c_msgs, srv, SaveMap_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_ig_lio_c_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ig_lio_c_msgs, srv, SaveMap_Response)() {
  return &::ig_lio_c_msgs::srv::rosidl_typesupport_c::SaveMap_Response_message_type_support_handle;
}
...
static const _SaveMap_type_support_symbol_names_t _SaveMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ig_lio_c_msgs, srv, SaveMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ig_lio_c_msgs, srv, SaveMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ig_lio_c_msgs, srv, SaveMap)() {
  return &::ig_lio_c_msgs::srv::rosidl_typesupport_c::SaveMap_service_type_support_handle;
}
