...
static const _SaveMap_Request_type_support_symbol_names_t _SaveMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ig_lio_c_msgs, srv, SaveMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ig_lio_c_msgs, srv, SaveMap_Request)),
  }
};
...
{
  return &::ig_lio_c_msgs::srv::rosidl_typesupport_cpp::SaveMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ig_lio_c_msgs, srv, SaveMap_Request)() {
  return get_message_type_support_handle<ig_lio_c_msgs::srv::SaveMap_Request>();
}
...
static const _SaveMap_Response_type_support_symbol_names_t _SaveMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ig_lio_c_msgs, srv, SaveMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ig_lio_c_msgs, srv, SaveMap_Response)),
  }
};
...
{
  return &::ig_lio_c_msgs::srv::rosidl_typesupport_cpp::SaveMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ig_lio_c_msgs, srv, SaveMap_Response)() {
  return get_message_type_support_handle<ig_lio_c_msgs::srv::SaveMap_Response>();
}
...
static const _SaveMap_type_support_symbol_names_t _SaveMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ig_lio_c_msgs, srv, SaveMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ig_lio_c_msgs, srv, SaveMap)),
  }
};
...
{
  return &::ig_lio_c_msgs::srv::rosidl_typesupport_cpp::SaveMap_service_type_support_handle;
}
