...
#include "ig_lio_c_msgs/srv/detail/save_map__rosidl_typesupport_fastrtps_c.h"
...
using _SaveMap_Request__ros_msg_type = ig_lio_c_msgs__srv__SaveMap_Request;
...
size_t get_serialized_size_ig_lio_c_msgs__srv__SaveMap_Request(
  const void * untyped_ros_message,
...
static uint32_t _SaveMap_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ig_lio_c_msgs__srv__SaveMap_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ig_lio_c_msgs
size_t max_serialized_size_ig_lio_c_msgs__srv__SaveMap_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ig_lio_c_msgs__srv__SaveMap_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ig_lio_c_msgs, srv, SaveMap_Request)() {
...
using _SaveMap_Response__ros_msg_type = ig_lio_c_msgs__srv__SaveMap_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ig_lio_c_msgs
size_t get_serialized_size_ig_lio_c_msgs__srv__SaveMap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SaveMap_Response__ros_msg_type * ros_message = static_cast<const _SaveMap_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ig_lio_c_msgs__srv__SaveMap_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ig_lio_c_msgs
size_t max_serialized_size_ig_lio_c_msgs__srv__SaveMap_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ig_lio_c_msgs__srv__SaveMap_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ig_lio_c_msgs, srv, SaveMap_Response)() {
...
// already included above
// #include "ig_lio_c_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ig_lio_c_msgs/srv/save_map.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ig_lio_c_msgs, srv, SaveMap)() {
