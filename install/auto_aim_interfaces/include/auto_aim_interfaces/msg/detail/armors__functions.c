...
auto_aim_interfaces__msg__Armors__are_equal(const auto_aim_interfaces__msg__Armors * lhs, const auto_aim_interfaces__msg__Armors * rhs)
{
  ...
  // get_armor
  if (lhs->get_armor != rhs->get_armor) {
    return false;
  }
  // armors
  ...
  auto_aim_interfaces__msg__Armors * output)
{
  ...
  // get_armor
  output->get_armor = input->get_armor;
  // armors
...
{
  auto_aim_interfaces__msg__Armors * msg = (auto_aim_interfaces__msg__Armors *)malloc(sizeof(auto_aim_interfaces__msg__Armors));
  if (!msg) {
    return NULL;
  }
...
auto_aim_interfaces__msg__Armors__Sequence__init(auto_aim_interfaces__msg__Armors__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (auto_aim_interfaces__msg__Armors *)calloc(size, sizeof(auto_aim_interfaces__msg__Armors));
    if (!data) {
      return false;
    }
...
{
  auto_aim_interfaces__msg__Armors__Sequence * array = (auto_aim_interfaces__msg__Armors__Sequence *)malloc(sizeof(auto_aim_interfaces__msg__Armors__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  auto_aim_interfaces__msg__Armors__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    auto_aim_interfaces__msg__Armors * data =
      (auto_aim_interfaces__msg__Armors *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!auto_aim_interfaces__msg__Armors__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          auto_aim_interfaces__msg__Armors__fini(&data[i]);
        }
        free(data);
        return false;
      }
