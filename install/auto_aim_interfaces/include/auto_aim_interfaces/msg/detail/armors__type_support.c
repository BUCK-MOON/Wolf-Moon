...
static rosidl_typesupport_introspection_c__MessageMember Armors__rosidl_typesupport_introspection_c__Armors_message_member_array[3] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Armors, get_armor),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auto_aim_interfaces, msg, Armors)() {
  ...
  Armors__rosidl_typesupport_introspection_c__Armors_message_member_array[2].members_ =
