...
{
  livox_ros_driver2__msg__CustomPoint * msg = (livox_ros_driver2__msg__CustomPoint *)malloc(sizeof(livox_ros_driver2__msg__CustomPoint));
  if (!msg) {
    return NULL;
  }
...
livox_ros_driver2__msg__CustomPoint__Sequence__init(livox_ros_driver2__msg__CustomPoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (livox_ros_driver2__msg__CustomPoint *)calloc(size, sizeof(livox_ros_driver2__msg__CustomPoint));
    if (!data) {
      return false;
    }
...
{
  livox_ros_driver2__msg__CustomPoint__Sequence * array = (livox_ros_driver2__msg__CustomPoint__Sequence *)malloc(sizeof(livox_ros_driver2__msg__CustomPoint__Sequence));
  if (!array) {
    return NULL;
  }
