# `armor-processor-node`
沈阳航空航天大学自瞄程序的后端

## `Brief`
主要用于装甲板的预测，移用了RV的整车预测模型。
RV是那颗宝石，而我只是做法杖的人。
...
|    msg   |      type       | topic                |
|    ---   |       ---       |  ---                 |
|  armors  |    Subscriber   | armor_detector/armors_msg
|   state  |    Publisher    | armor_processor/state_msg
|  gimbal  |    Publisher    | armor_processor/gimbal_msg
|  serial  |    Subscriber   | serial_msg
|  marker  |    Publisher    | armor_processor/marker_msg
...
>> |     file            |     class          | function |
>> |      ---            |     ---            | ---      |
>> | processor_node      | ProcessorNode      | 创建节点
>> | armor_processor     | ArmorProcessor     | 主要功能类
>> | ballistic_processor | BallisticProcessor | 弹道，位姿转换类
>> | armor_tracker       | Tracker  EKF       | RV的跟踪模型
---
...
发布：
- 最终云台串口发送 `/armor_processor/gimbal_msg`
...
![filter](docs/Kalman_filter_model.png)
