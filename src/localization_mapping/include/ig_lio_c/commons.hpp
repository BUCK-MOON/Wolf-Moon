#ifndef LOCALIZATION_MAPPING__COMMONS_HPP_
#define LOCALIZATION_MAPPING__COMMONS_HPP_
#include <mutex>
#include <vector>
#include <queue>
#include <string>
...
#endif//LOCALIZATION_MAPPING__COMMONS_HPP_