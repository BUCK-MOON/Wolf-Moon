#ifndef LOCALIZATION_MAPPING__ICP_LOCALIZER_HPP_
#define LOCALIZATION_MAPPING__ICP_LOCALIZER_HPP_
...
namespace IG_LIO
{
    ...
    {
        double rough_resolution = 0.5;    // 粗略的分辨率
        double refine_resolution = 0.2;   // 精细的分辨率
        double rough_iter = 10;           // 粗略的迭代次数
        double refine_iter = 5;           // 细致的迭代次数
        double thresh = 0.15;             // 阈值
        double xy_offset = 2.0;           // xy补偿
        int yaw_offset = 3;               // yaw补偿
        double yaw_resolution = M_PI / 6; // 航向角分辨率
    };
...
#endif  // LOCALIZATION_MAPPING__ICP_LOCALIZER_HPP