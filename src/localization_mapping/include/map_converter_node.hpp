#ifndef LOCALIZATION_MAPPING__MAP_CONERTER_NODE_HPP_
#define LOCALIZATION_MAPPING__MAP_CONERTER_NODE_HPP_
...
namespace IG_LIO
{
    ...
    {
    public:
        MapConverterNode(const rclcpp::NodeOptions &options = rclcpp::NodeOptions());
        ~MapConverterNode();
